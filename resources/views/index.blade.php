...
<html lang="en" data-bs-theme="auto">
  ...
  <head>
    ...
    <meta name="author" content="Fabio Oliveira Silva">
    ...
    <style>
      ...
      /* Customização para ajustar o título Dashboard ao topo */
      .content-header {
        padding-top: 0px; /* Remover padding adicional */
        margin-top: 0; /* Garantir que não tenha margin */
      }
      
      .content-container {
        margin-top: 0; /* Ajuste adicional para remover qualquer margin superior */
      }
    </style>
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content-container">
  ...
  <!-- Corrigido o posicionamento do título Dashboard -->
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom content-header">
